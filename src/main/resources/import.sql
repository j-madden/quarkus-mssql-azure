INSERT INTO airport (id ,ident ,type ,name ,latitude_deg ,longitude_deg ,elevation_ft ,continent ,iso_country ,iso_region ,municipality ,scheduled_service ,gps_code ,iata_code ,local_code ,home_link ,wikipedia_link ,keywords )
VALUES (6523,'00A','heliport','Total Rf Heliport',40.07080078125,-74.93360137939453,'11','NA','US','US-PA','Bensalem','no','00A','','00A','','',''),
...
(6528,'00CA','small_airport','Goldstone /Gts/ Airport',35.350498199499995,-116.888000488,'3038','NA','US','US-CA','Barstow','no','00CA','','00CA','','',''),
(6529,'00CO','small_airport','Cass Field',40.62220001220703,-104.34400177001953,'4830','NA','US','US-CO','Briggsdale','no','00CO','','00CO','','',''),
...
(6535,'00GE','heliport','Caffrey Heliport',33.88420104980469,-84.73390197753906,'957','NA','US','US-GA','Hiram','no','00GE','','00GE','','',''),
(6536,'00HI','heliport','Kaupulehu Heliport',19.832500457763672,-155.98199462890625,'43','NA','US','US-HI','Kailua/Kona','no','00HI','','00HI','','',''),
...
(6538,'00II','heliport','Bailey Generation Station Heliport',41.644500732421875,-87.122802734375,'600','NA','US','US-IN','Chesterton','no','00II','','00II','','',''),
